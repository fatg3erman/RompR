...
class internetPlaylist {
	...
	public static function load_internet_playlist($url, $image, $station, $return_tracks = false) {

		$playlist = self::download_remote_playlist($url, $image, $station);
		if ($playlist !== false) {
			if ($return_tracks) {
	...
	public static function download_remote_playlist($url, $image, $station) {
	...
	private static function asfOrasx($s) {
		$type = null;
