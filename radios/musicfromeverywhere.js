    ...
    return {
        ...
        setup: function() {
            if (lastfm.isLoggedIn && player.canPlay('spotify')) {
                ...
                $('#lastfm_mix').append(playlist.radioManager.standardBox('lfmartistradio dropdown', '7day', 'icon-lastfm-1', 'Monthly Dip'));
    ...
    return {
        setup: function() {
            if (lastfm.isLoggedIn && player.canPlay('spotify')) {
                ...
                $('#lastfm_track').append(playlist.radioManager.standardBox('lfmtrackradio dropdown', '7day', 'icon-lastfm-1', 'Monthly Mix'));
