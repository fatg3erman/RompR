...
print '<input class="autoset toggle openmenu" type="checkbox" id="search_limit_limitsearch" name="mopidysearchdomains"><label for="search_limit_limitsearch">'.get_int_text("label_limitsearch").'</label>';
print '</div>';
