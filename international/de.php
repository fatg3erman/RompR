...
$languages['de'] = array (
	...
	"lastfm_nobio" => "Keine vollständige Biographie verfügbar",
	...
	"lastfm_import" => "Importiere Deine Last.FM Bibliothek",
	"lastfm_pleaselogin" => "Sie müssen bei Last.FM angemeldet sein um das zu tun",
	"label_nosql" => "Das ist mit der aktuellen Konfiguration nicht möglich",
	"label_onlyloved" => "Nur Lieblingstitel",
	"label_onlytagged" => "Nur getaggte Titel",
	"label_tagandlove" => "Getaggte Titel und Lieblingstitel",
	"label_everything" => "Alles",
	"label_giveloved" => "Hole Lieblingstitel:",
	"stars" => "Sterne",
	"star" => "Stern",
	"norating" => "Keine Bewertung",
	"button_importnow" => "Importiere jetzt",
	"label_review" => "Ergebnisse vor dem Import bearbeiten",
	"label_addtowish" => "Wenn ein Titel nicht gefunden werden kann, setzte ihn auf die Wunschliste",
	"label_tags" => "Tags",
