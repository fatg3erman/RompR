...
$languages['pirate'] = array (
	...
	"lastfm_import" => "Bring in ye records o' magic red ball",
	"lastfm_pleaselogin" => "Avast! Ye be not in league wi' magic red ball",
	"label_nosql" => "Avast! Ye be not configured fer this sort o' thing",
	"label_onlyloved" => "Only ye beauties",
	"label_onlytagged" => "Only ye labelled shantys",
	"label_tagandlove" => "Beauties and Labelled",
	"label_everything" => "The lot!",
	"label_giveloved" => "Ye Beauties be measured as:",
	"stars" => "stars",
	"star" => "star",
	"norating" => "Nowt",
	"button_importnow" => "Arrrrr!",
	"label_review" => "Check up on this before writin' it down",
	"label_addtowish" => "If shanty is mysterious, add it to list o' wishes",
	"label_tags" => "Labels",
